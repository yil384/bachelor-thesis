...
\lstdefinelanguage{Rust}{
  morekeywords={let,mut,fn,enum,struct,impl,for,loop,match,if,else,while,break,continue,return,
                pub,use,crate,mod,super,self,const,static,ref,as,in,extern,move,unsafe,dyn},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]",
...
\usetikzlibrary{shapes.geometric} % 流程图
...
\setminted{
    frame=single,                 % 添加代码框
    framesep=2mm,                 % 框与代码之间的距离
    fontsize=\footnotesize,       % 代码字体大小
    breaklines=true,              % 自动换行
    breakanywhere=true,           % 允许在任何地方换行
    linenos=true,                 % 显示行号
    numbersep=3pt,                % 行号与代码之间的距离
    xleftmargin=5pt,              % 增加左边距
    xrightmargin=5pt,             % 增加右边距
}
